...
void executeCommand(String command) {
    ...
    if (command == "REL_PUMP1_ON") {
        ...
        rel_ph = true;
        Serial.printf("reviece firstRoots dosing ON\n");
        firstRoots();
        ...
        rel_micro = true;
        Serial.printf("received firstRoots dosing ON\n");
        firstRoots();
...
void firstRoots() {
  ...
  runMotor(2, 0.5); 
  rel_micro = false;
  sendMessage(roomName, username, "OFF" , "REL_MICRO");
  Serial.println("..................First roots dosing done..................");
